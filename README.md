...
我们致力于思考面向终端的数字人落地应用，并通过完整代码把思考结果呈现给大家。杰克的MCP开发平台框架，向上适配各种数字人模型技术，向下接入各式大语言模型，并且便于更换诸如TTS、ASR等模型，为单片机、app、网站提供全面的数字人应用接口。      
...
**交流群及资料教程**关注公众号 **杰克的MCP开发平台**（**请先star本仓库**）
